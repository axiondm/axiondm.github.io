...
![]({{ site.url }}{{ site.baseurl }}/images/respic/cylinder.png){: style="width: 300px; float: right; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/astronomy.png){: style="width: 300px; float: right; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/quantum_matter.png){: style="width: 300px; float: right; border: 10px"}
